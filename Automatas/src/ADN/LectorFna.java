...
public class LectorFna {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Scanner fnaInput = new Scanner(new File("C:\\Users\\JIMENO\\Documents\\vida artificial\\GCF_000181335.2_Felis_catus_8.0_genomic.fna"));
        PrintStream out = new PrintStream(new File("C:\\Users\\JIMENO\\Documents\\vida artificial\\GCF_000181335.2_Felis_catus_8.0_genomic.txt"));
        System.out.println("Reading .fna file...");
        StringBuilder sb = new StringBuilder(4000000);
        String lector = "";
        while (fnaInput.hasNextLine()) {
            lector = fnaInput.nextLine();
            sb.append(lector);
            out.println(lector);
        }
        out.close();
